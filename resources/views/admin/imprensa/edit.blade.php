        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <form action="{{ route('admin.imprensa.update',$noticia->slug) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">

                                    <h4 class="card-title">Actualizar Notícia de Imprensa</h4>
                                    <p class="card-title-desc">Formulário para actualizar notícia de imprensa no sistema.</p>
