                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc">Exibe a lista de todas notícias registradas no sistema,
                                        ...
                                        @foreach ($noticias as $noticia)
                                            <tr>
                                                ...
                                                <td class="row d-flex justify-content-between">
                                                    <div class="col">
                                                        <a href="{{ route('admin.noticia.edit', $noticia->slug) }}">
                                                            <i class=" text-warning ri-edit-2-fill"></i>
                                                        </a>
                                                    </div>
                                                    <div class="col">
                                                        <a href="{{ route('admin.noticia.remove', $noticia->slug) }}">
